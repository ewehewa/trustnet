<x-dashboard>
            ...
            <div class="card nft-card h-100 shadow-sm border-0">
              ...
              <div class="card-body text-center text-white d-flex flex-column justify-content-between">
                ...
                <div>
                  ...
                  {{-- Hide Buy button if the logged-in user owns the NFT --}}
                  @if(auth()->id() !== $nft->owner_id || $nft->owner_type !== 'App\Models\User')
                    <a href="{{ route('nfts.show', $nft->id) }}" class="btn btn-sm btn-outline-light w-100">
                      <i class="fas fa-shopping-cart me-1"></i> Buy Now
                    </a>
                  @else
                    <span class="badge bg-success">Your NFT</span>
                  @endif
  ...
  <style>
    ...
    .badge { font-size: 0.9rem; padding: 5px 10px; border-radius: 6px; }
